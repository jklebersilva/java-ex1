...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.printf(" Products%n %s, which price is $ %.2f%n %s, which price is $ %.2f%n", product1,
				price1,product2, price2);
		System.out.printf(" Produtos%n %s, que custa R$ %.2f%n %s que custa R$ %.2f%n", produto1,
				price1, produto2,price2);
